...
public class InicioSesion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            int aux = funcion(jTextField1.getText());
            int lugar = lugar(aux,tablaha.tam());
            ...
            Matriz auxM = tablaha.raiz(lugar, jTextField1.getText(),sb.toString());
            if(auxM!=null){
                Ventana nueva= new Ventana(auxM,jTextField1.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ReporteHash repot=new ReporteHash();
        repot.setVisible(true);
        repot.setLocationRelativeTo(null);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            bitacora.grafo();
            ReportePila rePi=new ReportePila();
            rePi.setVisible(true);
            rePi.setLocationRelativeTo(null);
